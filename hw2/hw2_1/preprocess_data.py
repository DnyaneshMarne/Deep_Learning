# -*- coding: utf-8 -*-
"""
Created on Thu Mar 14 17:40:26 2022
...
class data_pro_train():
    ...
    def featureDic(self):
        ...
        for file in files:
                ...
                value = np.load(os.path.join(self.feature_path, file))
...
#train = data_pro(train_JSON_path,train_feature_path)
